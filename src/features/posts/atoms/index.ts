...
export const addPostLikeAtom = atom(null, (get, set, postId: string) => {
...
export const removePostLikeAtom = atom(null, (get, set, postId: string) => {
  const current = get(postLikeStateAtom)
  set(postLikeStateAtom, {
    ...current,
...
export const isPostLikedAtom = (postId: string) =>
  atom(get => {
...
export const isPostLikeLoadingAtom = (postId: string) =>
  atom(get => {
    const state = get(postLikeStateAtom)
